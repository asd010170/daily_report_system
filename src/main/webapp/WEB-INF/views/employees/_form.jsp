...
<select name="${AttributeConst.EMP_ADMIN_FLG.getValue()}" id="${AttributeConst.EMP_ADMIN_FLG.getValue()}">
    <option value="${AttributeConst.ROLE_GENERAL.getValue()}"<c:if test="${employee.adminFlag == AttributeConst.ROLE_GENERAL.getValue()}"> selected</c:if>>一般</option>
    <option value="${AttributeConst.ROLE_ADMIN.getValue()}"<c:if test="${employee.adminFlag == AttributeConst.ROLE_ADMIN.getValue()}"> selected</c:if>>管理者</option>
</select>
<br /><br />
